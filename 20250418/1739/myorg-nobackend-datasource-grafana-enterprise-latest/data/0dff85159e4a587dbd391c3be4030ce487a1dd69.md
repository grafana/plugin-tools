...
Call log:
  - navigating to "http://localhost:3000/datasources/edit/fejbgaq6885xcb", waiting until "networkidle"
...
- banner:
  ...
  - navigation "Breadcrumbs":
    - list:
      ...
      - listitem: myorg-nobackend-datasource-49a69f62-61b8-4620-a8ea-ff54ba493f8d
  ...
  - button "Profile":
    - img "User avatar"
- main:
  - img "logo for myorg-nobackend-datasource-49a69f62-61b8-4620-a8ea-ff54ba493f8d"
  - heading "myorg-nobackend-datasource-49a69f62-61b8-4620-a8ea-ff54ba493f8d" [level=1]
  - text: Type No-Backend Alerting Not supported
  - link "Explore data":
    - /url: /explore?left=%7B%22datasource%22:%22myorg-nobackend-datasource-49a69f62-61b8-4620-a8ea-ff54ba493f8d%22,%22context%22:%22explore%22%7D
  - link "Build a dashboard":
    - /url: dashboard/new-with-ds/fejbgaq6885xcb
  - text: "Type: No-Backend"
  - tablist:
    - tab "Settings" [selected]
  - text: Name
  - img
  - textbox "Name": myorg-nobackend-datasource-49a69f62-61b8-4620-a8ea-ff54ba493f8d
  - text: Default
  - switch "Default"
  - text: Path
  - img
