---
title: Install the [plugin name] plugin" # Page title (required)
description: "How to install..." # SEO description (required)
sidebar_position: 2 # Navigation order (required)
---
