...
2. If the feature warrants a new doc page (e.g. you added RBAC roles and want to document them):
   ```
...
3. Update existing pages whose scope changed (e.g. you added a config field, so `configuration.md` needs an update):
   ```
