...
export const VALE_RULES: readonly ValeRule[] = [
  {
    ...
    swap: { 'allows to': 'allows you to|makes it possible to' },
  },
  {
    name: 'AndOr',
    extends: 'existence',
    ...
    link: 'https://developers.google.com/style/slashes#and-or',
    tokens: ['and/or'],
  },
  {
    name: 'Archives',
    ...
    link: 'https://developers.google.com/style/word-list#extract',
    swap: {
  ...
  },
  {
    ...
    swap: { 'dialog box appears': 'dialog box opens', modal: 'dialog box', 'dialog(?! box)': 'dialog box' },
  },
  {
    name: 'DropDown',
    extends: 'substitution',
    ...
    link: 'https://grafana.com/docs/writers-toolkit/write/style-guide/word-list/#drop-down',
    swap: { 'drop ?down': 'drop-down' },
  },
  {
    name: 'EndToEnd',
    extends: 'substitution',
    level: 'warning',
    message: "Use '%s' instead of '%s'.",
    link: 'https://grafana.com/docs/writers-toolkit/write/style-guide/word-list/#end-to-end',
    swap: { '[eE]2[eE]': 'end-to-end' },
  },
  {
    name: 'Exclamation',
    extends: 'existence',
  ...
  },
  {
    ...
    tokens: ['\\d{1,2}[AP]M\\b', '\\d{1,2} ?[ap]m\\b', '\\d{1,2} ?[aApP]\\.[mM]\\.'],
    nonword: true,
  },
  {
    name: 'GoogleDateFormat',
    extends: 'existence',
    level: 'error',
  ...
  },
  {
    ...
    tokens: ['he/she', 's/he', '\\(s\\)he'],
    ignorecase: true,
  },
  {
    name: 'GoogleGenderBias',
    extends: 'substitution',
    level: 'error',
  ...
  },
  {
    ...
    link: 'https://developers.google.com/style/abbreviations',
    tokens: ['tl;dr', 'ymmv', 'rtfm', 'imo', 'fwiw'],
    ignorecase: true,
  },
  {
    name: 'GoogleWill',
  ...
  },
  {
    ...
    swap: { 'e\\.?g[,.]?': 'for example', 'i\\.?e[,.]?': 'that is' },
    ignorecase: true,
  },
  {
    name: 'OK',
  ...
  },
  {
    ...
    tokens: ['1st', '2nd', '3rd', '4th', '5th', '6th', '7th', '8th', '9th'],
  },
  {
    name: 'Please',
    extends: 'existence',
  ...
  },
  {
    ...
    level: 'warning',
    message:
      "Use the compound adjective '%s' without a hyphen instead of '%s' whether the noun is implied or explicit. For example, you can use _quickstart guide_ or just _quickstart_.",
    link: 'https://grafana.com/docs/writers-toolkit/write/style-guide/word-list/#quickstart',
    swap: { 'quick start': 'quickstart' },
  },
  {
    name: 'React',
    extends: 'substitution',
    level: 'warning',
    message: "Use '%s' instead of '%s'.",
    link: 'https://grafana.com/docs/writers-toolkit/write/style-guide/word-list/#react',
    swap: { '[Rr]eact[. ]?[Jj][Ss]': 'React' },
    nonword: true,
  },
  {
    name: 'ReferTo',
  ...
  },
  {
    ...
    link: 'https://grafana.com/docs/writers-toolkit/write/style-guide/word-list/#simple',
    tokens: ['easy(?![ -]to[ -]understand)', 'easily', 'simple', 'simply'],
    exceptions: ['easy to understand', 'easy-to-understand'],
  },
  {
    name: 'Timeless',
    extends: 'existence',
...
export async function checkWritingStyle(input: ValidationInput): Promise<Diagnostic[]> {
  ...
  for (const entry of mdFiles) {
    ...
    // collected per file so they can be ordered by line before being reported - matchers run in
    // rule order, which would otherwise make the output jump around the page
    ...
    fileDiagnostics.sort((a, b) => (a.line ?? 0) - (b.line ?? 0));
