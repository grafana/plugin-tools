...
- Name: data query should return values 10 and 20
- Location: /home/runner/work/plugin-tools/plugin-tools/myorg-backend-datasource/tests/queryEditor.spec.ts:21:5
...
Call log:
  - waiting for getByLabel('Show more items')
    - locator resolved to <button tabindex="0" aria-label="Show more items" class="css-1chuu9v-toolbar-button">…</button>
  - attempting click action
    - waiting for element to be visible, enabled and stable
  - element was detached from the DOM, retrying

    at DashboardPage.addPanel (/home/runner/work/plugin-tools/plugin-tools/myorg-backend-datasource/node_modules/@grafana/plugin-e2e/dist/models/pages/DashboardPage.js:106:27)
