...
- Name: Test alert rule APIs >> advanced mode should be enabled
- Location: /home/runner/work/plugin-tools/plugin-tools/packages/plugin-e2e/tests/as-admin-user/datasource/alerting/alerting.advancedMode.spec.ts:7:7
...
Expected: true
Received: false
    at /home/runner/work/plugin-tools/plugin-tools/packages/plugin-e2e/tests/as-admin-user/datasource/alerting/alerting.advancedMode.spec.ts:9:63
```
...
- main:
  ...
  - group "2. Define query and alert condition Advanced options Advanced options":
    ...
    - text: Define query and alert condition Need help? Alert condition WHEN
    - log
    - text: Last
    - combobox
    - text: OF QUERY
  ...
  - group "5. Configure notifications Advanced options Advanced options":
    ...
    - switch "Advanced options"
    - heading "Alert instance routing preview" [level=5]
    - text: When you have your folder selected and your query and labels are configured, click "Preview routing" to see the results here.
    - button "Preview routing" [disabled]
