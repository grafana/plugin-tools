...
Call log:
  - navigating to "http://localhost:3000/datasources/edit/eejnqbba92z9cf", waiting until "networkidle"
...
- banner:
  ...
  - navigation "Breadcrumbs":
    - list:
      ...
      - listitem: myorg-backend-datasource-d575d416-f013-4b60-938f-7b68ccf8faeb
  ...
  - button "Profile":
    - img "User avatar"
- main:
  - img "logo for myorg-backend-datasource-d575d416-f013-4b60-938f-7b68ccf8faeb"
  - heading "myorg-backend-datasource-d575d416-f013-4b60-938f-7b68ccf8faeb" [level=1]
  - text: Type Backend Alerting Not supported
  - link "Explore data":
    - /url: /explore?left=%7B%22datasource%22:%22myorg-backend-datasource-d575d416-f013-4b60-938f-7b68ccf8faeb%22,%22context%22:%22explore%22%7D
  - link "Build a dashboard":
    - /url: dashboard/new-with-ds/eejnqbba92z9cf
  - text: "Type: Backend"
  - tablist:
    - tab "Settings" [selected]
  - text: Name
  - img
  - textbox "Name": myorg-backend-datasource-d575d416-f013-4b60-938f-7b68ccf8faeb
  - text: Default
  - switch "Default"
  - text: Path
  - img
