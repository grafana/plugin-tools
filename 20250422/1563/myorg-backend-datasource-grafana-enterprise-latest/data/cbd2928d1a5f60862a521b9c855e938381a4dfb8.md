...
Call log:
  - navigating to "http://localhost:3000/datasources/edit/dejnqd085wge8a", waiting until "networkidle"
...
- banner:
  ...
  - navigation "Breadcrumbs":
    - list:
      ...
      - listitem: myorg-backend-datasource-650aaffd-7553-463a-b2de-2f6cad5d0cea
  ...
  - button "Profile":
    - img "User avatar"
- main:
  - img "logo for myorg-backend-datasource-650aaffd-7553-463a-b2de-2f6cad5d0cea"
  - heading "myorg-backend-datasource-650aaffd-7553-463a-b2de-2f6cad5d0cea" [level=1]
  - text: Type Backend Alerting Not supported
  - link "Explore data":
    - /url: /explore?left=%7B%22datasource%22:%22myorg-backend-datasource-650aaffd-7553-463a-b2de-2f6cad5d0cea%22,%22context%22:%22explore%22%7D
  - link "Build a dashboard":
    - /url: dashboard/new-with-ds/dejnqd085wge8a
  - text: "Type: Backend"
  - tablist:
    - tab "Settings" [selected]
  - text: Name
  - img
  - textbox "Name": myorg-backend-datasource-650aaffd-7553-463a-b2de-2f6cad5d0cea
  - text: Default
  - switch "Default"
  - text: Path
  - img
