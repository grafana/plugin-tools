...
Call log:
  - navigating to "http://localhost:3000/datasources/edit/bejnqgl26gfeob", waiting until "networkidle"
...
- banner:
  ...
  - navigation "Breadcrumbs":
    - list:
      ...
      - listitem: myorg-nobackend-datasource-b0f569d8-923f-42b1-be3f-bed03182a14d
  ...
  - button "Profile":
    - img "User avatar"
- main:
  - img "logo for myorg-nobackend-datasource-b0f569d8-923f-42b1-be3f-bed03182a14d"
  - heading "myorg-nobackend-datasource-b0f569d8-923f-42b1-be3f-bed03182a14d" [level=1]
  - text: Type No-Backend Alerting Not supported
  - link "Explore data":
    - /url: /explore?left=%7B%22datasource%22:%22myorg-nobackend-datasource-b0f569d8-923f-42b1-be3f-bed03182a14d%22,%22context%22:%22explore%22%7D
  - link "Build a dashboard":
    - /url: dashboard/new-with-ds/bejnqgl26gfeob
  - text: "Type: No-Backend"
  - tablist:
    - tab "Settings" [selected]
  - text: Name
  - img
  - textbox "Name": myorg-nobackend-datasource-b0f569d8-923f-42b1-be3f-bed03182a14d
  - text: Default
  - switch "Default"
  - text: Path
  - img
