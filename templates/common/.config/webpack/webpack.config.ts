 ...
 *
 * This file will be updated and / or replaced in the future. If you need to customise the
 * webpack config we encourage you to use `webpack-merge` and create separate config files.
 *
 * ```
 * import { merge } from 'webpack-merge';
 * import grafanaConfig from './webpack/webpack.config';
 *
 * const config = (env) =>
