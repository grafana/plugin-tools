...
const sidebars: SidebarsConfig = {
  // The autogenerated sidebar is why we have all the _category_.json files
  // See: https://docusaurus.io/docs/sidebar/autogenerated#category-item-metadata
  // docs: [{ type: 'autogenerated', dirName: '.' }],

  // But, if we want to, we can manually define the sidebar in a single place
  // See: https://docusaurus.io/docs/sidebar/items
  // this makes all the _category_.json files redundant.
  ...
  docs: [
    ...
    },
    {
      ...
      items: [
        ...
        'tutorials/build-a-panel-plugin-with-d3',
