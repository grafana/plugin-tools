...
| Community | No; <br /> Free of charge | Community plugins contain dependent technologies that are open source and/or not for profit. <br /><br /> Community plugins are published to the official Grafana catalog, and are available to the Grafana community for direct installation. <br /> Support is provided by the individual developer and/or community. <br /><br /> Supported in Grafana Cloud. <br /><br /> Not commercial in nature and not affiliated with any commercial endeavor.
