...
| --- | --- | --- |
| Private | No; <br /> Free of charge  | Private plugins are for use on your own Grafana instance. <br /> They may not be shared to the Grafana community or to your customers, and are not published in the Grafana catalog. <br /> Private plugins are not supported in Grafana Cloud. |
