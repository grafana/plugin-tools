...
To package a plugin, refer to [Package a plugin](./package-a-plugin).

### Follow our guidelines

Get familiar with our plugin [publishing and signing criteria](./publishing-and-signing-criteria)
...
1. Click **Submit Plugin**. The Create Plugin Submission dialog appears.
  ...
  ![Submit plugin UI.](/img/plugins-submission-create2.png "Submit plugin UI")
