...
Develop the frontend part of a Grafana plugin in Typescript with ReactJS as the View library. Several commands are available within the `plugin` directory for interacting with the frontend.
...
Runs the linter against source code to verify that you have adhered to the formatting and styling rules.
