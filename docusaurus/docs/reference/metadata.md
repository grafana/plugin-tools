...
| **suggestions**                               | `boolean`  | For panel plugins. If set to true, the plugin's suggestions supplier will be invoked and any suggestions returned will be included in the Suggestions pane in the Panel Editor. Requires implementing `setSuggestionsSupplier` in `module.ts`. For details, refer to [Add visualization suggestions to panel plugins](/how-to-guides/panel-plugins/add-suggestions-support).<br/>                                                                                                                                                                                                                                                                                                                                                                |          |
...
| [**languages**](#languages)                   | `string[]` | The list of languages supported by the plugin. Each entry should be a locale identifier in the format `language-COUNTRY` (for example `en-US`, `es-ES`, `de-DE`).<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |          |
