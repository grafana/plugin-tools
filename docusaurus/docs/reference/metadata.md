...
| `reqAction`    | string                  | No       | The RBAC action a user must have to use this route. **Warning**: unless the action targets the plugin or one of its datasources, only the action is verified, not what it applies to. |
| `reqRole`      | string                  | No       |                                                                                                                                                                                       |
