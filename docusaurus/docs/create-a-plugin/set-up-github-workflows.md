...
This workflow requires a Grafana Cloud API key. Before you begin, follow the instructions for [distributing your plugin](../publish-a-plugin/distribute-a-plugin.md).
