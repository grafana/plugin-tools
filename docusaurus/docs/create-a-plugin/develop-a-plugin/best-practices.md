...
- **Consider creating custom options** - If the default panel options aren't a good fit for what you're trying to offer users, use [custom options](../../how-to-guides/panel-plugins/add-a-custom-panel-option-editor).
