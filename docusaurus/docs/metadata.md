...
| `preload`            | boolean                       | No       | Initialize plugin on startup. By default, the plugin initializes on first use, but when preload is set to true the plugin loads without user interaction. Only applicable to app plugins.                                                                                                                                                                                                               |
