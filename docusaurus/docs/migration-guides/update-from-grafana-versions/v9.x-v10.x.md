...
title: 9.x to 10.x
sidebar_position: 2
tags: grafana, plugins, migration, migrate plugins, grafaa v9, grafana v10
description: "Follow these instructions to migrate plugins from Grafana version 9.x to 10.x."
---
