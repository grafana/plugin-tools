...
sidebar_position: 7
tags: grafana, plugins, migration, migrate plugins, grafana v7, grafana v8
description: "Follow these instructions to migrate Grafana v7.x.x plugins to the updated plugin system available in Grafana v8.x.x."
---
