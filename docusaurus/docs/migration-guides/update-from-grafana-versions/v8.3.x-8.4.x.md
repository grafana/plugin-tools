...
sidebar_position: 6
tags: grafana, plugins, migration, migrate plugins, grafana v8
description: "Follow these instructions to migrate Grafana v8.3.x plugins to the updated plugin system available in Grafana v8.4.x."
---
