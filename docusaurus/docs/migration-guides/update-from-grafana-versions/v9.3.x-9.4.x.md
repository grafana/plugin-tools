...
](../../create-a-plugin/extend-a-plugin/add-authentication-for-data-source-plugins#forward-cookies-for-the-logged-in-user) or [Forward user header for the logged-in user](../../create-a-plugin/extend-a-plugin/add-authentication-for-data-source-plugins#forward-user-header-for-the-logged-in-user) for example usages.
