...
For more information about these files, refer to [Folder structure](developer-tools/get-started/folder-structure/).

## Build and run your plugin in Docker

With the `create-plugin` tool, you can use a Docker container to simplify the configuration, loading, and development processes. For more information, refer to [Set up development environment](developer-tools/get-started/set-up-development-environment/).
