...
import Youtube from '../shared/_youtube.mdx';
...
<Youtube videoId="AARrATeVEQY" />

**Watch our introductory video** to see a step-by-step guide on scaffolding your first Grafana plugin. This visual tutorial complements the detailed instructions below and provides practical insights to help you along the way.
