...
For a complete list of available CLI commands, refer to [CLI commands](/prompts-cli#cli-commands).
...
For a complete list of available CLI commands, refer to the [CLI reference](/prompts-cli.md#prompts).
