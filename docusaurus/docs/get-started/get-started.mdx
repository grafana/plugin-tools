...
If this is your first time creating a plugin, we recommend that you familiarize yourself with the fundamentals of plugin types, plugin frontend and backend components, data frames, and other essentials. Learn more about the [key concepts of Grafana plugin development](/key-concepts/).
