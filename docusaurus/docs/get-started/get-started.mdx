...
:::note
Yarn 1 is no longer supported by create-plugin. If you choose to run create-plugin using yarn 1 (`yarn create @grafana/plugin`) create-plugin will scaffold the plugin using the latest version of Yarn.
:::
