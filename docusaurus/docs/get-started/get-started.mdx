...
- Use a custom data source request proxy. To learn more, refer to [Backend developer resources](https://grafana.com/developers/plugin-tools/introduction/backend-plugins#resources).
