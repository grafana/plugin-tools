...
1. When prompted, enter answers to the given questions. For example:
  ...
  If you have previously built a plugin with `@grafana/toolkit`, you can use our plugin tools to simplify migration. For more information, refer to the [Migration guide](./get-started/migrate-from-toolkit).
