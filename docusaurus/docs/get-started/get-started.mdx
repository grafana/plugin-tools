...
Grafana plugin development allows you to create many different types of user experiences using [supported](https://grafana.com/developers/plugin-tools/key-concepts/grafana-plugin-sdk-for-go) features. For example, you can make:
