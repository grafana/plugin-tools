...
description:
  Set up your development environment with Docker for Grafana plugin development.
  - grafana
  - plugins
  - plugin
  - create-plugin
...
1. <SyncCommand cmd="run server" />: Starts a Grafana development server running
