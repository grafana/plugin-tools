...
To learn how to automate the release process and setup the release workflow, follow our documentation on [Automate packaging and signing with GitHub CI](../publish-a-plugin/build-automation).
