...
The [`create-plugin`](./get-started.mdx#use-plugin-tools-to-develop-your-plugins-faster) tool includes a development environment featuring [Docker](https://docs.docker.com/get-docker/). It allows you to start an instance of the Grafana application for plugin developers against which you can code.
