...
id: develop-locally
title: Develop with a local environment
description: Set up your local development environment for Grafana and plugin.
keywords:
  - grafana
  - plugins
  - plugin
...
- Grafana doesn't support debugging backend plugins running inside Docker. However, this is a [planned enhancement](https://github.com/grafana/grafana-plugin-sdk-go/issues/685).