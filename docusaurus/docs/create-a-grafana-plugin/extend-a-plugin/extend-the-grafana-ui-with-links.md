---
id: use-extensions-to-add-links-to-app-plugins
...
- It must be preloaded (by setting the [preload property](https://grafana.com/docs/grafana/latest/developers/plugins/metadata.md) to `true` in the `plugin.json`
