...
If any of these limitations apply to your plugin, you need to add a [backend plugin](../../introduction/backend). Because backend plugins run on the server, they can access decrypted secrets, which makes it easier to implement custom authentication methods.
