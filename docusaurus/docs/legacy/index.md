...
Since Grafana 7.0, writing plugins using Angular is no longer recommended. If you're looking to build a new plugin, refer to our [Plugins](https://grafana.com/docs/grafana/latest/developers/plugins) documentation.

:::

You can extend Grafana by writing your own plugins and then share them with other users in [our plugin catalog](https://grafana.com/plugins/).
...
- [Grafana Tutorials](https://grafana.com/docs/grafana/latest/developers/plugins/create-a-grafana-plugin/develop-a-plugin)
...
See the [coding styleguide](style-guide.md) for details on the metadata.

## module.(js|ts)

This is the entry point for every plugin. This is the place where you should export
your plugin implementation. Depending on what kind of plugin you are developing you
will be expected to export different things. You can find what's expected for [datasource](https://grafana.com/docs/grafana/latest/developers/plugins//data-sources.md), [panels](panels.md)
...
- [Getting Plugins to work in Snapshot Mode](https://grafana.com/docs/grafana/latest/developers/plugins/legacy/snapshot-mode/)
- [Plugin Defaults and Editor Mode](https://grafana.com/docs/grafana/latest/developers/plugins/legacy/defaults-and-editor-mode/)
- [Grafana Plugin Code Styleguide](https://grafana.com/docs/grafana/latest/developers/plugins/legacy/style-guide/)
- [Grafana Apps](https://grafana.com/docs/grafana/latest/developers/plugins/legacy/apps/)
- [Grafana Data Sources](https://grafana.com/docs/grafana/latest/developers/plugins/legacy/data-sources/)
- [plugin.json Schema](https://grafana.com/docs/grafana/latest/developers/plugins/legacy/metadata/)
