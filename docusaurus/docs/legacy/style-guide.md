...
For more information about the file format for `plugin.json` file, refer to [metadata](https://grafana.com/docs/grafana/latest/developers/plugins/metadata.md).
