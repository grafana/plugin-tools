...
To learn more about data transformations in Grafana, refer to [Transform data]({{< relref "https://grafana.com/docs/grafana/latest/panels-visualizations/query-transform-data/transform-data" >}}).
